...
#ifndef EUREKA_SWIFT_H
#define EUREKA_SWIFT_H
...
SWIFT_CLASS_NAMED("BaseCell")
@interface EurekaBaseCell : UITableViewCell
...
@interface EurekaFormViewController : UIViewController
...
@interface EurekaFormViewController (SWIFT_EXTENSION(Eureka)) <UIScrollViewDelegate>
- (void)scrollViewWillBeginDragging:(UIScrollView * _Nonnull)scrollView;
@end


@interface EurekaFormViewController (SWIFT_EXTENSION(Eureka))
...
@interface EurekaFormViewController (SWIFT_EXTENSION(Eureka)) <UITableViewDataSource>
...
@interface EurekaFormViewController (SWIFT_EXTENSION(Eureka)) <UITableViewDelegate>
...
SWIFT_CLASS_NAMED("NavigationAccessoryView")
@interface EurekaNavigationAccessoryView : UIToolbar
